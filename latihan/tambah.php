...
if(isset($_POST['simpan'])){
	...
	$tambah_mahasiswa	= "INSERT INTO mahasiswa (nama_mahasiswa, nim, alamat, jenis_kelamin) VALUES ('$nama_mahasiswa','$nim','$alamat', '$jenis_kelamin')";
	...
	if(($mahasiswa > 0) AND ($ortu > 0)){
		echo"<script>alert('Data mahasiswa dengan nama mahasiswa $nama_mahasiswa dan nama orang tuanya $nama_ortu berhasil disimpan.');document.location='index.php'</script>";
	}
	else{
		echo"<script>alert('Data mahasiswa beserta orang tuanya gagal tersimpan.');document.location='index.php'</script>";
	}
}
?>